...
## Project Structure
    ...
    ├── tst_dsafawvqwvewevc_67174  # Django project configurations
...
1. Clone this repo and `cd tst_dsafawvqwvewevc_67174`
...
2. Clone this repo and `cd tst_dsafawvqwvewevc_67174`
