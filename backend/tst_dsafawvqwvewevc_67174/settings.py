"""
Django settings for tst_dsafawvqwvewevc_67174 project.
...
ROOT_URLCONF = 'tst_dsafawvqwvewevc_67174.urls'
...
WSGI_APPLICATION = 'tst_dsafawvqwvewevc_67174.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_dsafawvqwvewevc_67174 API",
    "DESCRIPTION": "API documentation for tst_dsafawvqwvewevc_67174 App",
    "VERSION": "v1",
}
